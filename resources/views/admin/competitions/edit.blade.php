    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.competitions.update", [$competition->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $competition->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $competition->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organized_by') ? 'is-invalid' : '' }}" type="text" name="organized_by" id="organized_by" value="{{ old('organized_by', $competition->organized_by) }}">
