...
return new MatchResource(Match::with(['team_home', 'team_away', 'category', 'competetion', 'stage', 'stadium', 'collaborator'])->get());
...
return new MatchResource($match->load(['team_home', 'team_away', 'category', 'competetion', 'stage', 'stadium', 'collaborator']));
