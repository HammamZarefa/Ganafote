...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.lineup.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.lineups.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_starter') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_starter" id="is_starter" value="1" {{ old('is_starter', 0) == 1 ? 'checked' : '' }}>
