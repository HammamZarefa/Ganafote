    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Client::IS_COLLABORATOR_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_collaborator') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_collaborator_{{ $key }}" name="is_collaborator" value="{{ $key }}" {{ old('is_collaborator', 'client') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('township') ? 'is-invalid' : '' }}" type="text" name="township" id="township" value="{{ old('township', '') }}">
