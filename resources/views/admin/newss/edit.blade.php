...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.newss.update", [$news->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="button_title">{{ trans('cruds.news.fields.button_title') }}</label>
                <input class="form-control {{ $errors->has('button_title') ? 'is-invalid' : '' }}" type="text" name="button_title" id="button_title" value="{{ old('button_title', $news->button_title) }}">
                @if($errors->has('button_title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('button_title') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.news.fields.button_title_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="button_link">{{ trans('cruds.news.fields.button_link') }}</label>
                <input class="form-control {{ $errors->has('button_link') ? 'is-invalid' : '' }}" type="text" name="button_link" id="button_link" value="{{ old('button_link', $news->button_link) }}">
                @if($errors->has('button_link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('button_link') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.news.fields.button_link_helper') }}</span>
            </div>
            <div class="form-group">
