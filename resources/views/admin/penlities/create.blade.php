...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.penlity.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.penlities.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penlity_order') ? 'is-invalid' : '' }}" type="number" name="penlity_order" id="penlity_order" value="{{ old('penlity_order', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('result') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="result" id="result" value="1" required {{ old('result', 0) == 1 ? 'checked' : '' }}>
